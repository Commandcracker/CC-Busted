...
return function(options)
  ...
  handler.suiteEnd = function()
    ...
    --pretty.pretty_print({tostring(statusString()):byte(1,-1)})
    --print("1 success / 0 failures / 1 error / 0 pending : ")
    --"\48"

    local ESC = '\27' -- ANSI escape sequences
    local CSI = ESC.."[" -- Control Sequence Introducer
    local STX = '\2' -- Start of Text
    local ETX = '\3' -- End of Text
    local EOT = '\4' -- End of Transmission

    local function e(number) -- escape
        return CSI .. number .. 'm'
    end
    print("-----------------------")
    print(
      e(32).."1"..e(0).."_success_/_"..
      e(31).."0"..e(0).."_failures_/_"..
      e(35).."1"..e(0).."_error_/_"..
      e(33).."0"..e(0).."_pending_:_"..
      e(1).."0.004"..
      e(0).."_seconds"
    )
    print("-----------------------")
    --        success / 0 failures / 1 error / 
    --io_write("success / 0 failures / 1 error / wxyz".. "\n")
